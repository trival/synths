...
function $m_Laudio_gsb_dynamic\uff3fplayback_audio$package$() {
  if ((!$n_Laudio_gsb_dynamic\uff3fplayback_audio$package$)) {
    $n_Laudio_gsb_dynamic\uff3fplayback_audio$package$ = new $c_Laudio_gsb_dynamic\uff3fplayback_audio$package$();
  }
  return $n_Laudio_gsb_dynamic\uff3fplayback_audio$package$;
}
export { $m_Laudio_gsb_dynamic\uff3fplayback_audio$package$ as $m_Laudio_gsb_dynamic\uff3fplayback_audio$package$ };
